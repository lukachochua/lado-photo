<div id="navbar-sm" class="absolute hidden z-50">
    <div id="categories-sm" class="rounded w-28 bg-gray-800">
        <div onmouseover="showCategories()" onmouseout="hideCategories()" class="relative">
            ...
            <div id="categories" class="hidden bg-gray-800 w-28 rounded-md text-white py-2 z-10 absolute top-0 left-24">
