<x-admin-layout>
    ...
    <div class="flex flex-col items-center mt-32">
        <div class="mb-8">
            <h1
                class="text-4xl text-center text-purple-500 hover:text-green-500 transform hover:scale-110 transition duration-300 ease-in-out font-bold">
                Welcome, Admin!
            </h1>
        </div>
        <div class="flex-grow">
            <p
                class="text-2xl text-center text-purple-500 hover:text-green-500 transform hover:scale-110 transition duration-300 ease-in-out font-bold">
